...
def createTimeStamp(datestr, format="%Y-%m-%d %H:%M:%S"):
    """Generates as timestamp"""
    return time.mktime(time.strptime(datestr, format))

class poloniex:
    def __init__(self, APIKey, Secret):
        """Get your keys from poloniex.com"""
        self.APIKey = APIKey
        self.Secret = Secret
    ...
    def returnOpenOrders(self,currencyPair):
        ...
        "currencyPair" POST parameter, e.g. "BTC_XCP"
    ...
    def buy(self,currencyPair,rate,amount):
        """
        Places a buy order in a given market. Required POST parameters are 
    ...
    def sell(self,currencyPair,rate,amount):
        """
        Places a sell order in a given market. Required POST parameters are 
        "currencyPair", "rate", and "amount". 
        If successful, the method will return the order number.
